...
//                .limit(bpFilter.stateList.size()/bpFilter.evolutionResolution-1) // -1 remove the state in the end of the b-thread
//                .peek(statistics)
...
//                    }
//            bpFilter.stateEstimatedList.add(StateEstimation.fittestIndividual(evolutionResult));
...
//            estimationAccuracy.add(BPFilter.stateEstimatedList.get(i).equals(BPFilter.stateList.get(BPFilter.evolutionResolution *(i+1))));
//        }
...
////            count = 0;
////            real = BPFilter.stateList.get(BPFilter.evolutionResolution *(i+1)).getBThreadSnapshots();
